...
export default function NewListingsServicePage() {
    return (
        <main className="h-screen overflow-clip">
            ...
            <span className={"flex h-full w-full p-4"}>
                ...
                <LogStreamViewer serviceEndpoint={"/keymaster/logs"} service={"New Listings Service"} />
            </section>
            <section className={"w-2/6 flex flex-col items-center "}>
                <PingService service={"New Listings Service"}/>
            </section>
            </span>
        </main>
    )
