...
import com.ineedhousing.models.dtos.LogEventListWrapperDto;
...
public class LogService {
    ...
    public LogEventListWrapperDto getMostRecentLogs(Integer limit) {
        List<LogEvent> logs =  mostRecentLogsCircularBuffer.getMostRecentLogs(limit);
        return new LogEventListWrapperDto(logs);
    }

    public LogEventListWrapperDto getMostRecentLogsCircularBuffer() {
