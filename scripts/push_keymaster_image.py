...
repo_name = "keymaster-service-repo"
...
def main():
    ...
    image_name = build_and_push_with_unique_tag(repo_name=repo_name, service=app_service_name, directory=keymaster_service, image_name_creator=make_gcp_image)
