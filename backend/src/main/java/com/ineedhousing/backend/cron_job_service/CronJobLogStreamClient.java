...
public class CronJobLogStreamClient extends WebSocketClient {
    ...
    public CronJobLogStreamClient(@Value("${cron.job.service.url}") String serviceUrl, LogStreamProcessor logStreamProcessor, CronJobLogStreamService cronJobLogStreamService) throws URISyntaxException {
    ...
    public void onMessage(String logLine) {
        try {
            ...
            cronJobLogStreamService.addLog(log);
